...
<div>
  <h1 style="text-align: center;">ALTERAR ORÇAMENTO PARA ESTOFADOS</h1>
</div>

<div class="container" style="text-align: center;">

<form action="./controle/orcamento/orcamento_altera.php" method="post">

<div style="text-align: center;">
  <table>
  <tr>
    <td>
      <label class="control-label">ID ORÇAMENTO:</label>
      <input type="text" class="form-control" readonly name="id_orca" name="id_orca" value="<?php echo $id; ?>">
    </td>
    <td>
    <label class="control-label">CLIENTE / EMPRESA:</label>
      <?php
      $sql = "SELECT cliente_nome FROM orcamento where id_orcamento = '$id'";
      $result_sql = mysqli_query($conn, $sql);

      $cliente_orca = mysqli_fetch_array($result_sql);
      ?>
    <input name="cliente_orca" size="30" readonly class="form-control" id="cliente_orca" value="<?php echo $cliente_orca['cliente_nome']; ?>">
    </td>
    <td>
    <label class="control-label">FUNCIONARIO:</label>
      <?php
      $sql = "SELECT funcionario_id FROM orcamento where id_orcamento = '$id'";
      $result_sql = mysqli_query($conn, $sql);
      $cliente_orca = mysqli_fetch_array($result_sql);

      $sql2 = "SELECT nome FROM pessoa INNER JOIN funcionario WHERE id_funcionario = '$cliente_orca[funcionario_id]'";
      $result_sql2 = mysqli_query($conn, $sql2);
      $cliente_orca2 = mysqli_fetch_array($result_sql2);
      ?>
    <input name="funcionario" readonly class="form-control" size="30" id="funcionario" value="<?php echo $cliente_orca2['nome']; ?>">
    </td>
    <td>
    ...
    <select name="tipo_orca" class="form-control" id="tipo_orca">
      ...
      <?php
      $sql = "SELECT tipo_orca FROM orcamento WHERE id_orcamento = '$id'";
      $result_sql = mysqli_query($conn, $sql);
      $tipo_orca = mysqli_fetch_array($result_sql); ?>
        <option selected value="<?php echo $tipo_orca['tipo_orca']; ?>"><?php echo $tipo_orca['tipo_orca']; ?></option>
...
<table class="table-sm" id="sofa">
  ...
  <tr class="table-primary">
    ...
    <td>
      ...
      <label>altura:</label>
      <input style="width: 30%;" type="text" onKeyPress="return Apenas_Numeros(event);" name="altura_ace" id="altura_ace" placeholder="CENTIMETRO"><br>
      <label>largura:</label>
      <input style="width: 30%;" min="100" type="number" onKeyPress="return Apenas_Numeros(event);" name="largura_ace" id="largura_ace" placeholder="CENTIMETRO"><br>
      <label>comprimento:</label>
      <input style="width: 30%;" min="100" type="number" onKeyPress="return Apenas_Numeros(event);" name="profundidade_ace" id="profundidade_ace" placeholder="CENTIMETRO">
      </div>
    </td>
    <td>
    ...
    <td id="seguraca_assentos" style="text-align: right; display:none;">
        <label>margen de seguraça:</label>
  ...
  <tr>
    ...
    <td class="table-warning">
        ...
        <label>MEDIDAS:</label><br>
        <label>altura:</label>
        <input style="width: 30%;" type="text" onKeyPress="return Apenas_Numeros(event);" name="altura_enc" id="altura_enc" placeholder="CENTIMETRO"><br>
        <label>largura:</label>
        <input style="width: 30%;" min="100" type="number" onKeyPress="return Apenas_Numeros(event);" name="largura_enc" id="largura_enc" placeholder="CENTIMETRO"><br>
        <label>comprimento:</label>
        <input style="width: 30%;" min="100" type="number" onKeyPress="return Apenas_Numeros(event);" name="profundidade_enc" id="profundidade_enc" placeholder="CENTIMETRO">
        </div>
    </td>
    <td class="table-warning">
    ...
    <td class="table-danger">
      <button type="submit" formtarget="_blank"  name="button" id="button">ALTERAR ORÇAMENTO</button>
  ...
  <tr class="table-success">
    ...
    <td>
      ...
      <label>MEDIDAS:</label><br>
      <label>altura:</label>
      <input style="width: 30%;" type="text" onKeyPress="return Apenas_Numeros(event);" name="altura_alm" id="altura_alm" placeholder="CENTIMETRO"><br>
      <label>largura:</label>
      <input style="width: 30%;" min="100" type="number" onKeyPress="return Apenas_Numeros(event);" name="largura_alm" id="largura_alm" placeholder="CENTIMETRO"><br>
      <label>comprimento:</label>
      <input style="width: 30%;" min="100" type="number" onKeyPress="return Apenas_Numeros(event);" name="profundidade_alm" id="profundidade_alm" placeholder="CENTIMETRO">
      </div>
    </td>
    <td>
